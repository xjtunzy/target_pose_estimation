...
if __name__ == "__main__":
    filename1 = r"E:\dataset\test\test\ellipse8.bmp"
    ...
    filename4 = r"E:\dataset\aamed_ellipse_datasets\Smartphone Images - Dataset #2\images\05_00024.bmp"
    img = cv.imread(filename4)
    gray = cv.cvtColor(img,cv.COLOR_BGR2GRAY)
    gray = cv.GaussianBlur(gray, (5, 5), 1.0)
    # medianBlur_ksize = 3
